...
exports.casting=async function main(voter,elNum,btNum,sel) {
    ...
    var date = (d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate());
        ...
        const castResponse = await contract.submitTransaction('cast', btNum, elNum, date ,sel);
